...
import { D as DOMEvent, a as isString, l as listenEvent, j as createReactComponent, k as useStateContext, m as useReactContext, n as useSignal, q as composeRefs, r as useSignalRecord, e as effect, t as useReactScope, v as signal, s as scoped } from './chunks/vidstack-c3208662.js';
export { z as appendTriggerEvent, y as findTriggerEvent, w as hasTriggerEvent, B as isKeyboardClick, C as isKeyboardEvent, A as isPointerEvent, x as walkTriggerEventChain } from './chunks/vidstack-c3208662.js';
import { G as GroupedLog, a as TextTrackSymbol, P as Primitive, M as MediaPlayerInstance, k as MediaProviderInstance, m as mediaState, n as mediaContext, T as TextTrack, o as ToggleButtonInstance, u as useMediaState, q as PosterInstance, r as MediaRemoteControl, s as findActiveCue, t as ThumbnailsLoader, v as IS_SERVER, w as sliderState, x as updateSliderPreviewPlacement } from './chunks/vidstack-16cb0cf6.js';
export { a7 as ARIAKeyShortcuts, al as AudioProviderLoader, aR as AudioRadioGroup, ag as AudioTrackList, C as CaptionButton, aX as CaptionButtonInstance, V as Captions, bk as CaptionsInstance, aS as CaptionsRadioGroup, R as ChapterTitle, aQ as ChaptersRadioGroup, y as Controls, aB as ControlsGroup, aW as ControlsGroupInstance, aV as ControlsInstance, aw as DefaultAudioLayout, av as DefaultLayout, ax as DefaultVideoLayout, F as FullscreenButton, aY as FullscreenButtonInstance, a2 as FullscreenController, U as Gesture, bl as GestureInstance, an as HLSProviderLoader, a1 as List, E as LiveButton, aZ as LiveButtonInstance, a6 as MEDIA_KEY_SHORTCUTS, a5 as MediaControls, O as Menu, aK as MenuButton, be as MenuButtonInstance, bd as MenuInstance, aL as MenuItem, bg as MenuItemInstance, aO as MenuItems, bf as MenuItemsInstance, aM as MenuPortal, bh as MenuPortalInstance, B as MuteButton, a_ as MuteButtonInstance, D as PIPButton, a$ as PIPButtonInstance, A as PlayButton, b0 as PlayButtonInstance, aj as PlayerQueryList, aU as QualityRadioGroup, aP as Radio, N as RadioGroup, bi as RadioGroupInstance, bj as RadioInstance, a4 as ScreenOrientationController, S as SeekButton, b1 as SeekButtonInstance, H as Slider, aJ as SliderChapters, bc as SliderChaptersInstance, aE as SliderController, b5 as SliderInstance, aI as SliderPreview, bb as SliderPreviewInstance, aF as SliderThumbnail, b8 as SliderThumbnailInstance, aH as SliderValue, b9 as SliderValueInstance, aG as SliderVideo, ba as SliderVideoInstance, aT as SpeedRadioGroup, ac as TextRenderers, af as TextTrackList, X as Thumbnail, bm as ThumbnailInstance, W as Time, bn as TimeInstance, a9 as TimeRange, K as TimeSlider, b6 as TimeSliderInstance, z as Tooltip, aD as TooltipContent, b4 as TooltipContentInstance, b2 as TooltipInstance, aC as TooltipTrigger, b3 as TooltipTriggerInstance, am as VideoProviderLoader, ak as VideoQualityList, J as VolumeSlider, b7 as VolumeSliderInstance, _ as canChangeVolume, a3 as canFullscreen, $ as canOrientScreen, e as canPlayHLSNatively, a0 as canRotateScreen, b as canUsePictureInPicture, d as canUseVideoPresentation, ay as defaultLayoutContext, Z as formatSpokenTime, Y as formatTime, az as getDefaultLayoutLang, ab as getTimeRangesEnd, aa as getTimeRangesStart, ao as isAudioProvider, ah as isCueActive, aq as isHLSProvider, ar as isHTMLAudioElement, at as isHTMLMediaElement, as as isHTMLVideoElement, ad as isTrackCaptionKind, ap as isVideoProvider, aN as menuPortalContext, ai as observeActiveTextTrack, ae as parseJSONCaptionsFile, au as sliderContext, a8 as softResetMediaState, bq as useActiveTextCues, br as useActiveTextTrack, bs as useAudioOptions, bt as useCaptionOptions, bu as useChapterOptions, aA as useDefaultLayoutContext, bp as useMediaStore, bw as usePlaybackRateOptions, bo as usePlayerQuery, bv as useVideoQualityOptions } from './chunks/vidstack-16cb0cf6.js';
...
class LibASSTextRenderer {
  ...
  canRender(track) {
    return !!track.src && (isString(track.type) && this.va.test(track.type) || this.va.test(track.src));
  }
  attach(video) {
    this.loader().then(async (mod) => {
      this.ua = new mod.default({
        ...this.config,
        video,
        subUrl: this.ta?.src || ""
      });
      listenEvent(this.ua, "ready", () => {
        const canvas = this.ua?.xa;
        if (canvas)
          canvas.style.pointerEvents = "none";
      });
      listenEvent(this.ua, "error", (event) => {
        if (this.ta) {
          this.ta[TextTrackSymbol.ya] = 3;
          this.ta.dispatchEvent(
            new DOMEvent("error", {
              trigger: event,
              detail: event.error
            })
  ...
  changeTrack(track) {
    if (!track || track.readyState === 3) {
      this.wa();
    } else if (this.ta !== track) {
      this.ua?.setTrackByUrl(track.src);
      this.ta = track;
    }
  }
  detach() {
