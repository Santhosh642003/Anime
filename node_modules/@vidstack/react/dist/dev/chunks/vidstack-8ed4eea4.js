...
class AudioProviderLoader {
  ...
  async load() {
    ...
    return new (await import('./vidstack-bfae7a00.js')).AudioProvider(this.target);
  }
}
...
class VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-2b6ea3f4.js')).VideoProvider(this.target, context);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-55b7eb7e.js')).HLSProvider(this.target, context);
  }
};
...
const SETUP = Symbol("SETUP" ), sourceTypes = /* @__PURE__ */ new Map();
